  ...
  <DIV class='top_img'>
    ...
    <NAV class='top_menu'>
      ...
      <c:choose>
        ...
        <c:otherwise>
          <A class='menu_link'  href='/member/member_login.do' >Login</A><span class='top_menu_sep'> </span>
        </c:otherwise>
      </c:choose>    
      ...
      <A class='menu_link'  href='/member/member_create.do'>회원가입</A><span class='top_menu_sep'> </span>
