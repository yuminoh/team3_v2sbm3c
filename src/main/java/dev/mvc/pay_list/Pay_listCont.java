...
public class Pay_listCont {
	...
	public String pay_create(HttpSession session, int productno, int ordercnt) {
		...
		ProductsVO productdata = this.productsProc.product_read(productno);
	...
	public String interested_products_list(int memberno) {
		...
		if(interested_products.size()==3) {			
			...
			HashMap<String, Object> map = new HashMap<String, Object>();
			  ...
			  map.put("sub_no3",interested_sub_categorys[2]);
			  List<Pay_listVO> interested_pay_list=this.Pay_listProc.pay_list_interested(map);
	...
	public String recommend(HttpSession session, int sub_categoryno) {
		...
		System.out.println(recommend_productVO);
